...
const fixedAssets: Omit<LibraryAsset, 'downloads' | 'shares' | 'galleries' | 'viewers' | 'publicViews' | 'publicDownloads' | 'favorites' | 'lastDownloadDate' | 'captureDate'>[] = [
  // Task A1: Known-Item, Time-Sensitive - Lebron from last night
  {
    ...
    aspectRatio: "16:9",
    status: "approved",
    tags: ["Lebron James", "Lakers", "King James", "game action", "basketball", "NBA", "dunk", "Lebron Dunks", "Lebron Highlights"],
    fileSize: "4.2 MB",
  ...
  // Task B: Time Pressure + Accuracy - Player X action with Sponsor Y branding
  {
    ...
    aspectRatio: "16:9",
    status: "approved",
    tags: ["Lebron James", "Lakers", "King James", "dunk", "slam dunk", "action", "celebration", "Gatorade", "Sponsor Y", "courtside", "basketball", "NBA", "branding", "Lebron Dunks", "Lebron Lakers"],
    fileSize: "5.1 MB",
    dimensions: "3840x2160",
  },
  {
    ...
    aspectRatio: "16:9",
    status: "approved",
    tags: ["Lebron James", "Lakers", "King James", "celebration", "fist pump", "action", "Nike", "Sponsor Y", "basketball", "NBA", "branding", "victory", "Lebron Highlights", "Lebron Lakers"],
    fileSize: "4.8 MB",
    dimensions: "1920x1080",
  },
  // Additional Lebron + Nike assets for filter testing
  {
    ...
    aspectRatio: "1:1",
    status: "approved",
    tags: ["Lebron James", "Lakers", "Nike", "portrait", "basketball", "NBA", "Lebron Lakers"],
    fileSize: "2.1 MB",
  ...
  },
  {
    ...
    aspectRatio: "9:16",
    status: "approved",
    tags: ["Lebron James", "Lakers", "Nike", "advertisement", "vertical", "basketball", "NBA", "Lebron Highlights", "Lebron Lakers"],
    fileSize: "1.8 MB",
...
export function searchAssets(assets: LibraryAsset[], filters: SearchFilters): LibraryAsset[] {
  ...
  return results.filter((asset) => {
    ...
    // Tag filter - ANY tag must match (OR logic, case-insensitive)
