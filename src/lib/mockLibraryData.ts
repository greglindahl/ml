...
const fixedAssets: LibraryAsset[] = [
  // Task A1: Known-Item, Time-Sensitive - Lebron from last night
  {
    ...
    aspectRatio: "16:9",
    status: "approved",
    tags: ["Lebron James", "Lakers", "King James", "game action", "basketball", "NBA", "dunk"],
    fileSize: "4.2 MB",
  ...
  // Task B: Time Pressure + Accuracy - Player X action with Sponsor Y branding
  {
    ...
    aspectRatio: "16:9",
    status: "approved",
    tags: ["Lebron James", "Lakers", "King James", "dunk", "slam dunk", "action", "celebration", "Gatorade", "Sponsor Y", "courtside", "basketball", "NBA", "branding"],
    fileSize: "5.1 MB",
    dimensions: "3840x2160",
  },
  {
    ...
    aspectRatio: "16:9",
    status: "approved",
    tags: ["Lebron James", "Lakers", "King James", "celebration", "fist pump", "action", "Nike", "Sponsor Y", "basketball", "NBA", "branding", "victory"],
    fileSize: "4.8 MB",
    dimensions: "1920x1080",
  },
