          ...
          <Tabs defaultValue="verified-shares" className="flex-1 flex flex-col">
            <TabsList className="flex items-center gap-3 bg-transparent p-0 h-auto">
              <TabsTrigger
                ...
                className="flex flex-col justify-center items-center py-2 px-3 text-[15px] font-light rounded-md border border-transparent text-[#6E84A3] data-[state=active]:border-primary data-[state=active]:text-primary data-[state=active]:bg-transparent"
              >
                Verified Shares
              </TabsTrigger>
              <TabsTrigger
