...
import type {
  CampaignsTableColumnKey,
  CampaignsTableColumnVisibility,
...
export function CampaignsTable({ campaigns, searchQuery, perPage = 40, columnVisibility }: CampaignsTableProps) {
  const isVisible = (key: CampaignsTableColumnKey) =>
